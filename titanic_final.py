...
for dataset in combine:
    ...
    dataset['Fare'] = dataset['Fare'].fillna(0)  # 결측치가 있으면 0
...
#### --> ERROR 원인
print('ERROR 원인')
print(test['FareBand'].head())
print(test[test.FareBand.isna()])
...
# KeyError: 'AbSp' 발생하여 드롭
# print(train['AbSp'].head())
# train = train.drop(['AbSp'],axis = 1)
# test = test.drop(['AbSp'],axis = 1)
# *****
# 모델 학습과 검증
# *****
